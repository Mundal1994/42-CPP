...
/*   Updated: 2022/11/04 16:45:57 by molesen          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::setClapTrap(const std::string str, unsigned int health, \
...
/*	get the ClapTrap private values	*/
std::string	ClapTrap::getClapTrap_name(void)
{
	return ((*this).name);
}

unsigned int	ClapTrap::getClapTrap_hit(void)
{
	return ((*this).hit);
}

unsigned int	ClapTrap::getClapTrap_energy(void)
{
	return ((*this).energy);
}

unsigned int	ClapTrap::getClapTrap_damage(void)
{
	return ((*this).damage);
}
