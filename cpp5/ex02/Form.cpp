...
/*   Updated: 2023/01/09 11:58:15 by molesen          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*	Default constructor	*/
Form::Form(const std::string &str, bool stat, int valSign, int valExec) : name(str), status(stat), gradeSign(valSign), gradeExecute(valExec)
{
	try
	{
